...
* Application layer standards (ERCs):  
  ...
  * [ERC8206](https://github.com/ethereum/ERCs/pull/1624/changes): Physical commodity-backed token  
  * [ERC8207](https://github.com/ethereum/ERCs/pull/1625/changes): Tokenized gold (ERC8206 extension)

### Agents

* [Open wallet standard](https://x.com/moonpay/status/2036081106303222258): local wallet storage & signing, designed for AI agents  
* Jtriley: [contracts can serve prompt injections](https://x.com/jtriley2p/status/2036872558650548637)  
* Pashov Audit Group skills [v2](https://github.com/pashov/skills/releases/tag/v2) (security review): adds 7 types of security agents
...
#### All core devs \- execution (ACDE) [\#233](https://forkcast.org/calls/acde/233)
...
#### All core devs \- testing (ACDT) [\#75](https://forkcast.org/calls/acdt/075)

* [Glamsterdam](https://forkcast.org/upgrade/glamsterdam) upgrade (targeting mid-2026):  
  * [EIP7732](https://forkcast.org/eips/7732) ePBS  
    * Adding cached PTC window (previous \+ next 2 epochs) to state  
    * Variable PTC deadline is non-consensus changing & can be added after the upgrade

### Layer 1

* [Hegotá](https://forkcast.org/upgrade/hegota/) upgrade (targeting late-2026):  
  * FOCIL breakout [\#31](https://x.com/jih2nn/status/2036714998291194242)  
  * EIP8141 Frame transaction breakout [\#2](https://forkcast.org/calls/one-off-1985/002): [transaction pool strategies](https://hackmd.io/@matt/frame-mempool)  
* Ethereum improvement proposals (EIPs):  
  * EF Protocol support: [EIP champions handbook](https://ps.ethereum.foundation/guides/champion)  
  * [EIP8200](https://github.com/ethereum/EIPs/pull/11432/changes): EVMification (replace RIPEMD-160, MODEXP, BLAKE2f & BLS12 map-to-curve precompiles with bytecode)  
  * [EIP8201](https://github.com/ethereum/EIPs/pull/11437/changes): Pre-ingestion timestamp verification  
  * [EIP8202](https://github.com/ethereum/EIPs/pull/11438/changes): Scheme-agile transactions  
  * [EIP8205](https://github.com/ethereum/EIPs/pull/11450/changes): Withdrawal credentials preregistration

### Staking

* EthStaker [staking survey](https://ethstaker.org/forms/staking-landscape-survey-2026), stakers & non-stakers can complete  
* Ethereum Validators Association (EVA) [hub](https://hub.ethva.org/): signal on EIPs, stake-weighted  
* Origin [OETH migrating to compounding validators](https://x.com/OriginProtocol/status/2036099980771918308)  
...
* Client releases:  
  ...
  * Execution layer:  
    * Erigon [v3.3.10](https://github.com/erigontech/erigon/releases/tag/v3.3.10) (recommended): transaction pool, RPC & CL improvements
...
*Permalink: [ethereal.news/ethereal-news-weekly-17/](https://ethereal.news/ethereal-news-weekly-17/)*  
